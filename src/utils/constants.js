import { Home as HomeIcon, Bed, UtensilsCrossed, Umbrella, Mail, HelpCircle, BookOpen, Car, Utensils, BellRing, Clock, Cigarette, Dog, Users, PlusCircle, Paperclip, MessageCircle, Briefcase, User } from 'lucide-react';
