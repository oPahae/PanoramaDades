  ...
  return (
    <>
      ...
      <aside
        ...
        className={`hidden lg:flex fixed top-0 left-0 h-full z-50 bg-stone-50/95 backdrop-blur-xl border-l border-stone-200/50 shadow-lg transition-all duration-500 ${desktopOpen ? 'w-64' : 'w-16'
