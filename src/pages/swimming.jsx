...
export default function Rooms() {
  ...
  const galleryImages = [
    { url: '/swimming/main.png', span: 'col-span-2 row-span-2' },
    { url: '/swimming/1.png', span: 'col-span-1 row-span-1' },
    { url: '/swimming/2.jpg', span: 'col-span-1 row-span-1' },
    { url: '/swimming/3.png', span: 'col-span-1 row-span-2' },
    { url: '/swimming/4.png', span: 'col-span-1 row-span-1' },
    ...
    <div className="min-h-screen bg-stone-50 relative overflow-hidden">
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden py-64">
        ...
        <div className="absolute inset-0">
          <div
            className="absolute inset-0 bg-cover bg-center transform scale-110 bg-[url('/swimming/main.png')]"
          />
